...
$rowsCount = mysqli_fetch_assoc(mysqli_query(openConn(), "SELECT COUNT(empID) as exp FROM employee "))['exp'];
...
if (isset($_GET["search"]["value"]) && !empty($_GET["search"]["value"])) {
    ...
    $getAllFactureQuery = "select * from employee " . $orderString . " LIMIT " . $rowsReq . " OFFSET " . $start;
